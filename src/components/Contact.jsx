...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
        ...
        formData.append("access_key", "49a830ee-b32b-4aac-a22e-f8f1767abd9f");
    ...
    return (
        ...
        className='text-center p-6 py-20 lg:px-32 w-full overflow-hidden ' id="Contact">
            <h1 className='text-2xl sm:text-4xl font-bold mb-2 text-center'>Contact 
                <span className='underline underline-offset-4 decoration-1 under ml-1 font-light'>With Us</span></h1>
            ...
            <form onSubmit={onSubmit} className='max-w-2xl mx-auto text-gray-600 pt-8'>
                <div className='flex flex-wrap'>
                    <div className='w-full md:w-1/2 text-left'>
                        ...
                        px-4 mt-2' name='Name' type="text" placeholder='enter your name ' required />
                    </div>
                    <div className='w-full md:w-1/2 text-left md:pl-4'>
                        Your Email
                        <input className='w-full border border-gray-300 rounded py-3
                        px-4 mt-2' name='Email' type="email" placeholder='enter your email ' required />
                    </div>
