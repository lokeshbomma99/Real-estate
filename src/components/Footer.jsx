...
const Footer = () => {
  return (
    <div className='pt-10 px-4  md:px-20 lg:32 bg-gray-900 w-full overflow-hidden' id="Footer">
      <div className='container mx-auto flex flex-col md:flex-row justify-between items-start'>
        <div className='w-full md:w-1/3 mb-8 md:mb-0'>
          ...
          <p className='text-gray-400 mt-4'>Lorem ipsum dolor sit amet consectetur adipisicing elit.
            Praesentium vitae numquam accusantium odio voluptate provident at est laboriosam.
            Nesciunt eveniet laboriosam enim reprehenderit consectetur?
            Deleniti reprehenderit quisquam consectetur molestias optio?</p>
        </div>
      ...
      <div className='border border-gray-700 py-4 mt-10 text-center text-gray-500 mb-2'>
        Copyright 2024 @ lokesh. All Right Reserved.
      </div>
    </div>
  )
}
